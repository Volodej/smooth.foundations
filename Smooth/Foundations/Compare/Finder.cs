...
namespace Smooth.Compare
{
	...
	public static class Finder
    {
        ...
        private static readonly Dictionary<Type, object> equalityComparers = new Dictionary<Type, object>(typeComparer)
            {{typeof(Type), typeComparer}};
                ...
                if (customType != null)
                {
                    if (typeof(Configuration).IsAssignableFrom(customType))
                    {
                        ...
                        if (ctor != null)
                            ...
                            SmoothLogger.LogError("A " + customConfigurationClassName +
                                                  " class exists in your project, but will not be used because it does have a default constructor.");
                    }
                    else
                    {
                        SmoothLogger.LogError("A " + customConfigurationClassName +
                                              " class exists in your project, but will not be used because it does not inherit from " +
        ...
        /// <summary>
        ///     Registers sort order and equality comparers for KeyValuePair
        ///     <K, V>
        ///         s.
        ...
        /// <summary>
        ///     Registers a sort order comparer for type T where T implements IComparable
        ///     <T>
        ///         .
        ...
        /// <summary>
        ///     Registers an equality comparer for type T where T implements IEquatable
        ///     <T>
        ///         .
        ///         Used to circumvent potential JIT exceptions on platforms without JIT compilation.
        /// </summary>
        ...
        /// <summary>
        ///     Registers sort order and equality comparers for type T where T implements IComparable
        ///     <T>
        ///         and IEquatable
        ///         <T>
        ///             .
        ...
        /// <summary>
        ///     Registers a sort order comparer with the specified comparison and an equality comparer with the specified equals and hashCode functions
        ///     for type T.
        /// </summary>
        ...
        ///     Note: On platforms without JIT compilation, the supplied comparers should respectively inherit from Smooth.Collections.Comparer
        ///     <T> and Smooth.Collections.EqualityComparer<T> in order to force the AOT compiler to create the proper generic types.
        /// </summary>
        ...
        ///     Note: On platforms without JIT compilation, the supplied comparer should inherit from Smooth.Collections.Comparer
        ///     <T> in order to force the AOT compiler to create the proper generic types.
        /// </summary>
        ...
        ///     Note: Do not call this method directly as it is part of the internal API and a new comparers may be created on every call.  Use
        ///     Smooth.Collections.Comparer<T>.Default to get the default sort order comparer.
        /// </summary>
        ...
        ///     Note: On platforms without JIT compilation, the supplied comparer should inherit from Smooth.Collections.EqualityComparer
        ///     <T> in order to force the AOT compiler to create the proper generic types.
        /// </summary>
        ...
        ///     Note: Do not call this method directly as it is part of the internal API and a new comparers may be created on every call.  Use
        ///     Smooth.Collections.EqualityComparer<T>.Default to get the default equality comparer.
        /// </summary>

...
namespace Smooth.Delegates {
	...
	public static class DelegateExtensions {
		...
		/// </summary>
		public static void Apply<T>(this T t, Action<T> a) {
			a(t);
		}
		...
		/// </summary>
		public static void Apply<T, P>(this T t, Action<T, P> a, P p) {
		...
		/// </summary>
		public static U Apply<T, U, P>(this T t, Func<T, P, U> f, P p) {
			return f(t, p);
		}
